class Security {
    ...
    constructor(){
        ...
        this.access1.style('background', 'burlywood');  

        this.button1 = createButton('Check');
        this.button1.position(100,120);
        this.button1.style('background', 'cornflowerblue');    

        this.access2 = createInput().attribute("placeholder","Code2");
        this.access2.position(700,190);
        this.access2.style('background', 'burlywood');  

        this.button2 = createButton('Check');
        this.button2.position(700,220);
        this.button2.style('background', 'cornflowerblue');
//add code for creating and positioning the third input box and button
        ...
        this.access3.style('background', 'burlywood');
        
        this.button3=createButton('Check');
        this.button3.position(100,320);
        this.button3.style('background', 'cornflowerblue');
